...
8. Transactions must be audited to prevent theft from the vending machine:
- Each transaction must generate a line in a file called `Log.txt`.
- The audit entry must be in the format:
  - _date_ _time_ _transaction_ _starting-balance_ _ending-balance_

```
01/01/2016 12:00:00 PM FEED MONEY: $0.00 $5.00
